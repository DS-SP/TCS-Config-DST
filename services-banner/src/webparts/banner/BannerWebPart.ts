  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    return {
      pages: [
        ...
        {
          header: { description: strings.PromotedPropertyPaneDescription},
          groups: [
            {
              groupName: strings.PromotedGroupName,
              groupFields: [
                PropertyPaneTextField("promotedHeading", {
                  label: strings.PromotedHeading,
                }),
                PropertyPaneTextField("promotedParagraph", {
                  label: strings.PromotedParagraph,
                }),
                PropertyPaneTextField("promotedReadMoreLink", {
                  label: strings.PromotedReadMoreLink,
                }),
              ],
            },
          ],
